...
@section('content')
    <form method="post" action="/add_snack" enctype="multipart/form-data">
        @csrf
        <div class="self-center text-center">
            ...
            <div class="a-section m-3">
                ...
                <textarea class="w-3/12 px-4 py-2 @error ('description') border border-red-500 @enderror"
                          rows="8" name="description" placeholder="talk about the snack"></textarea>
                @error ('description')
                <div class="alert-message text-red-500">
                    {{ $message }}
                </div>
            ...
            <div class="a-section m-3">
                <label class="block" for="snackImage">Upload image:</label>
